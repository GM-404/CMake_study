...
PYBIND11_MODULE(bind_three_sum, m) // // 定义 Python 模块，模块名为 "bind_sum"，变量 m 是模块对象
{
    ...
    pybind11::class_<Solution_three_sum>(m, "Solution_three_sum") //"ExampleClass" 是 Python 中的类名
                                                                  // 定义构造函数
        ...
        .def("three_sum", &Solution_three_sum::three_Sum);
}

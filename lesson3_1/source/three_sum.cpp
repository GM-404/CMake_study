...
std::vector<std::vector<int>> Solution_three_sum::three_Sum(std::vector<int> &nums)
{
...
//      Solution_three_sum solution;
//      std::vector<std::vector<int>> result = solution.three_Sum(nums);
